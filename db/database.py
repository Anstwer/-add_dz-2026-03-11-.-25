...
# Постоянное расписание (0 - Пн, 1 - Вт, ..., 6 - Вс)
WEEKLY_SCHEDULE = {
    0: ["Разговоры о важном", "Биология", "Английский язык", "История", "Русский язык", "Вероятность и статистика", "Литература"], # Понедельник
    1: ["Химия", "Английский язык", "Геометрия", "Информатика", "Физика", "Алгебра", "Общество"],       # Вторник
    2: ["Биология", "ОБЗР", "Геометрия", "Физика", "Русский язык", "Алгебра"],          # Среда
    3: ["Литература", "История", "Классный час", "Геогафия", "Английский язык", "Русский язык", "Алгебра", "Физкультура"],                      # Четверг
    4: ["География", "Литература", "Физкультура", "Химия",  "Физика", "Русский язык", "Труд"],                         # Пятница
    5: [], # Суббота (оставь пустым, если не учитесь)
    6: []  # Воскресенье
}
